...
namespace Solution.Desktop.MaterialOutStorageInfo.View
{
    ...
    /// </summary>
    public partial class MaterialOutStorageInfoAddView3 : UserControlBase
    {
        public MaterialOutStorageInfoAddView3()
        {
            InitializeComponent();
        ...
        private void OutStorageType_SelectionChanged(object sender, System.Windows.Controls.SelectionChangedEventArgs e)
        {
            ...
            else if (OutStorageType.SelectedIndex == (int)OutStorageTypeEnumModel.OutStorageType.MaterialAutoShowOutStorageType - 1)
            { }
        }
