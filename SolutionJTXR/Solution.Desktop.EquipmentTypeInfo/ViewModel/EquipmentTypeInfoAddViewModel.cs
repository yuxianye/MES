...
namespace Solution.Desktop.EquipmentTypeInfo.ViewModel
{
    ...
    /// 新增
    /// </summary>
    public class EquipmentTypeInfoAddViewModel : VmBase
    {
        /// <summary>
        /// 构造函数
        /// </summary>
        public EquipmentTypeInfoAddViewModel()
        {
        ...
        {
            var result = Utility.Http.HttpClientHelper.PostResponse<OperationResult>(GlobalData.ServerRootUri + "EquipmentTypeInfo/Add",
