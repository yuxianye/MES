...
namespace Solution.Desktop.MaterialInStorageInfo.ViewModel
{
    ...
    /// </summary>
    public class MaterialInStorageInfoAuditViewModel : VmBase
    {
        /// <summary>
        /// 构造函数
        /// </summary>
        public MaterialInStorageInfoAuditViewModel()
        {
        ...
        #region 入库类型模型 
        System.Array instorageTypes = Enum.GetValues(typeof(InStorageTypeEnumModel.InStorageType)).Cast<InStorageTypeEnumModel.InStorageType>().Select(value => new { Key = value, Value = value.ToDescription() }).ToArray();
        ...
        #region 入库状态模型 
        System.Array instorageStatus = Enum.GetValues(typeof(InStorageStatusEnumModel.InStorageStatus)).Cast<InStorageStatusEnumModel.InStorageStatus>().Select(value => new { Key = value, Value = value.ToDescription() }).ToArray();
        ...
        {
            var result = Utility.Http.HttpClientHelper.PostResponse<OperationResult>(GlobalData.ServerRootUri + "MaterialInStorageInfo/Audit",
        ...
        //public System.Array auditStatus = Enum.GetValues(typeof(AuditStatusEnumModel.AuditStatus1));
        ...
        private void getPageDataMatSupplier(int pageIndex, int pageSize)
        {
            ...
            //Console.WriteLine(await (await _httpClient.GetAsync("/api/service/WareHouseInfo/Get?id='1'")).Content.ReadAsStringAsync());
            //
            var result = Utility.Http.HttpClientHelper.PostResponse<OperationResult<PageResult<MatSupplierInfoModel>>>(GlobalData.ServerRootUri + "MatSupplierInfo/PageData2", Utility.JsonHelper.ToJson(pageRepuestParams));
