...
namespace Solution.Desktop.MaterialInStorageInfo.ViewModel
{
    ...
    /// </summary>
    public class MaterialInStorageInfoEditViewModel : VmBase
    {
        /// <summary>
        /// 构造函数
        /// </summary>
            ...
            if (!Equals(result, null) && result.Successed)
            {
                ...
                if (result.Data.Data.Any())
                {
                    ...
                    foreach (var data in result.Data.Data)
                    {
                        ...
                        matpalletinfo = data;
                        //
                        if (matpalletinfo.WareHouseLocationCode == null && ( matpalletinfo.Id == MaterialInStorageInfo.PalletID ||
                                                                             matpalletinfo.MaterialInStorageQuantity == 0 ))
                        {
