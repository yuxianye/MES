...
namespace Solution.Desktop.MaterialInStorageInfo.ViewModel
{
    ...
    /// </summary>
    public class MaterialInStorageInfoAddViewModel1 : VmBase
    {
        /// <summary>
        /// 构造函数
        /// </summary>
        public MaterialInStorageInfoAddViewModel1()
        {
            ...
            //空托盘入库
            MaterialInStorageInfo.InStorageType = InStorageType.PalletInStorageType;
            //待组盘
            ...
            if (!Equals(result, null) && result.Successed)
            {
                ...
                if (result.Data.Data.Any())
                {
                    ...
                    foreach (var data in result.Data.Data)
                    {
                        ...
                        matpalletinfo = data;
                        //
                        if (matpalletinfo.WareHouseLocationCode == null && matpalletinfo.MaterialInStorageQuantity == 0)
                        {
