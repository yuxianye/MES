...
namespace Solution.Desktop.CommOpcUaNode.ViewModel
{
    ...
    /// 新增
    /// </summary>
    public class CommOpcUaNodeAddViewModel : VmBase
    {
        /// <summary>
        /// 构造函数
        /// </summary>
        public CommOpcUaNodeAddViewModel()
        {
        ...
        /// Opc Ua数据点数据模型
        /// </summary>
        private CommOpcUaNodeModel commOpcUaNodeModel = new CommOpcUaNodeModel();
        /// <summary>
        /// Opc Ua数据点数据模型
        /// </summary>
        ...
        private void OnExecuteConfirmCommand()
        {
            ...
            this.CommOpcUaNodeModel.ServerId = this.CommOpcUaServerInfo.Id;
            this.CommOpcUaNodeModel.ServerName = this.CommOpcUaServerInfo.ServerName;
            var result = Utility.Http.HttpClientHelper.PostResponse<OperationResult>(GlobalData.ServerRootUri + "CommOpcUaNode/Add",
