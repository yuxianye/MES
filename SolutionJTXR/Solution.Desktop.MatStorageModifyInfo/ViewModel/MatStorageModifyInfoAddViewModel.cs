...
namespace Solution.Desktop.MatStorageModifyInfo.ViewModel
{
    ...
    /// </summary>
    public class MatStorageModifyInfoAddViewModel : VmBase
    {
        /// <summary>
        /// 构造函数
        /// </summary>
        ...
        {
            var result = Utility.Http.HttpClientHelper.PostResponse<OperationResult>(GlobalData.ServerRootUri + "MatStorageModifyInfo/Add",
