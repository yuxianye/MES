...
namespace Solution.Desktop.EquipmentProgramInfo.ViewModel
{
    ...
    /// 新增
    /// </summary>
    public class EquipmentProgramInfoAddViewModel : VmBase
    {
        /// <summary>
        /// 构造函数
        /// </summary>
        public EquipmentProgramInfoAddViewModel()
        {
        ...
        {
            var result = Utility.Http.HttpClientHelper.PostResponse<OperationResult>(GlobalData.ServerRootUri + "EquipmentProgramInfo/Add",
