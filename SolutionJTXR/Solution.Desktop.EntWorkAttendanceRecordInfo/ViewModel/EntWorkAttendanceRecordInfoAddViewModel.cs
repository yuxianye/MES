...
namespace Solution.Desktop.EntWorkAttendanceRecordInfo.ViewModel
{
    ...
    /// 新增
    /// </summary>
    public class EntWorkAttendanceRecordInfoAddViewModel : VmBase
    {
        /// <summary>
        /// 构造函数
        /// </summary>
        public EntWorkAttendanceRecordInfoAddViewModel()
        {
        ...
        private void OnExecuteConfirmCommand()
        {
            ...
            var result = Utility.Http.HttpClientHelper.PostResponse<OperationResult>(GlobalData.ServerRootUri + "EntWorkAttendanceRecordInfo/Add",
        ...
        private void OnExecuteSelectionChangedCommand()
        {
            ...
            //this.EntEmployeeInfoModel.EntEmployeeCode = entEmployeeInfoList
            //getPageData1();

            //EntEmployeeInfoModel.DepartmentInfoName = EntDepartmentInfoList

            //this.EntWorkAttendanceRecordInfoModel.EntEmployeeCode
        }
