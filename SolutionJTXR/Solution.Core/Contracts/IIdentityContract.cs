...
namespace Solution.Core.Contracts
{
    ...
    public interface IIdentityContract : IScopeDependency
    {
        ...
        /// <returns>业务操作结果</returns>
        Task<OperationResult> AddRoles(params RoleInputDto[] inputDtos);
        ...
        /// <returns>业务操作结果</returns>
        Task<OperationResult> EditRoles(params RoleInputDto[] inputDtos);
        ...
        /// <returns>业务操作结果</returns>
        Task<OperationResult<object>> Login(LoginInfo loginInfo, bool shouldLockout);

        IQueryable<Object> GetUserRoleModules(User user);
