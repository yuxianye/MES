...
namespace Solution.Desktop.CommOpcUaServer.ViewModel
{
    ...
    /// 新增
    /// </summary>
    public class CommOpcUaServerEditViewModel : VmBase
    {
        /// <summary>
        /// 构造函数
        /// </summary>
        public CommOpcUaServerEditViewModel()
        {
        ...
        {
            this.CommOpcUaServerModel = parameter as CommOpcUaServerModel;
        }
        ...
        /// Socket通信模型
        /// </summary>
        private CommOpcUaServerModel commOpcUaServerModel;// = new EnterpriseModel();
        /// <summary>
        /// Socket通信模型
        /// </summary>
        ...
        private void OnExecuteConfirmCommand()
        {
            ...
            var result = Utility.Http.HttpClientHelper.PostResponse<OperationResult>(GlobalData.ServerRootUri + "CommOpcUaServer/Update",
