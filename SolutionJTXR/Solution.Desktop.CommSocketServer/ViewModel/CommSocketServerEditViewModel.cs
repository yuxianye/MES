...
namespace Solution.Desktop.CommSocketServer.ViewModel
{
    ...
    /// 新增
    /// </summary>
    public class CommSocketServerEditViewModel : VmBase
    {
        /// <summary>
        /// 构造函数
        /// </summary>
        public CommSocketServerEditViewModel()
        {
        ...
        {
            this.CommSocketServerModel = parameter as CommSocketServerModel;
        }
        ...
        /// Socket通信模型
        /// </summary>
        private CommSocketServerModel commSocketServerModel;// = new EnterpriseModel();
        /// <summary>
        /// Socket通信模型
        /// </summary>
        ...
        private void OnExecuteConfirmCommand()
        {
            ...
            var result = Utility.Http.HttpClientHelper.PostResponse<OperationResult>(GlobalData.ServerRootUri + "CommOpcUaSocket/Update",
