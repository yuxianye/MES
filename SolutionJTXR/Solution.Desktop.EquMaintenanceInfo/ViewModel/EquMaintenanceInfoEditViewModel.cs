...
namespace Solution.Desktop.EquMaintenanceInfo.ViewModel
{
    ...
    /// 新增
    /// </summary>
    public class EquMaintenanceInfoEditViewModel : VmBase
    {
        /// <summary>
        /// 构造函数
        /// </summary>
        public EquMaintenanceInfoEditViewModel()
        {
        ...
        {
            this.EquMaintenanceModel = parameter as EquMaintenanceModel;
        }
        #region 设备维护信息模型
        ...
        {
            var result = Utility.Http.HttpClientHelper.PostResponse<OperationResult>(GlobalData.ServerRootUri + "EquMaintenanceInfo/Update",
