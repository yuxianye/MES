...
namespace Solution.Desktop.EquSparePartTypeInfo.ViewModel
{
    ...
    /// 编辑VM
    /// </summary>
    public class EquSparePartTypeInfoEditViewModel : VmBase//《注意：模块主VM与增加和编辑VM继承的基类不同》
    {
        /// <summary>
        /// 构造函数
        /// </summary>
        public EquSparePartTypeInfoEditViewModel()
        {
        ...
        {
            this.EquSparePartTypeModel = parameter as EquSparePartTypeModel;
        }
        ...
        {
            var result = Utility.Http.HttpClientHelper.PostResponse<OperationResult>(GlobalData.ServerRootUri + "EquSparePartTypeInfo/Update",
