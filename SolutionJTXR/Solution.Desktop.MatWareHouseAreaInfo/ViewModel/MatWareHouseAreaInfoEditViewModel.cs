...
namespace Solution.Desktop.MatWareHouseAreaInfo.ViewModel
{
    ...
    /// </summary>
    public class MatWareHouseAreaInfoEditViewModel : VmBase
    {
        /// <summary>
        /// 构造函数
        /// </summary>
        public MatWareHouseAreaInfoEditViewModel()
        {
        ...
        {
            this.MatWareHouseAreaInfo = parameter as MatWareHouseAreaInfoModel;
        }
        ...
        {
            var result = Utility.Http.HttpClientHelper.PostResponse<OperationResult>(GlobalData.ServerRootUri + "MatWareHouseAreaInfo/Update",
