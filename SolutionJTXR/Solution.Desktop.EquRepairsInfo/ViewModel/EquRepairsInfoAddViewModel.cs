...
namespace Solution.Desktop.EquRepairsInfo.ViewModel
{
    ...
    /// 新增
    /// </summary>
    public class EquRepairsInfoAddViewModel : VmBase
    {
        /// <summary>
        /// 构造函数
        /// </summary>
        public EquRepairsInfoAddViewModel()
        {
        ...
        private void OnExecuteConfirmCommand()
        {
            ...
            var result = Utility.Http.HttpClientHelper.PostResponse<OperationResult>(GlobalData.ServerRootUri + "EquRepairsInfo/Add",
