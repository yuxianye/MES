...
namespace Solution.Desktop.EquMaintenancePlanInfo.ViewModel
{
    ...
    /// 新增
    /// </summary>
    public class EquMaintenancePlanInfoEditViewModel : VmBase
    {
        /// <summary>
        /// 构造函数
        /// </summary>
        public EquMaintenancePlanInfoEditViewModel()
        {
        ...
        private void OnExecuteConfirmCommand()
        {
            ...
            var result = Utility.Http.HttpClientHelper.PostResponse<OperationResult>(GlobalData.ServerRootUri + "EquMaintenancePlanInfo/Update",
