...
{
    [Description("任务信息")]
    public class TaskInfoInputDto : IInputDto<Guid>, IAudited
    {
        /// <summary>
        /// 主键Id
        /// </summary>
        ...
        /// 目的地标点
        /// </summary>
        public Guid TargetPointInfo_Id { get; set; }
        ...
        /// 任务车辆
        /// </summary>
        public Guid TaskCar_Id { get; set; }
        ...
        /// 路径库
        /// </summary>
        public Guid RouteInfo_Id { get; set; }
