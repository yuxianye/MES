...
namespace Solution.Desktop.MatPalletInfo.ViewModel
{
    ...
    /// </summary>
    public class MatPalletInfoAddViewModel : VmBase
    {
        /// <summary>
        /// 构造函数
        /// </summary>
        public MatPalletInfoAddViewModel()
        {
        ...
        {
            var result = Utility.Http.HttpClientHelper.PostResponse<OperationResult>(GlobalData.ServerRootUri + "MatPalletInfo/Add",
