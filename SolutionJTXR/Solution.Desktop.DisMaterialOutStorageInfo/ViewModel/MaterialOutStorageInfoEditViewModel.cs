...
namespace Solution.Desktop.MaterialOutStorageInfo.ViewModel
{
    ...
    /// </summary>
    public class MaterialOutStorageInfoEditViewModel : VmBase
    {
        /// <summary>
        /// 构造函数
        /// </summary>
        ...
        /// 库位选择项改变命令
        /// </summary>
        public ICommand WareHouseLocationSelectionChangedCommand { get; set; }
        ...
        {
            var result = Utility.Http.HttpClientHelper.PostResponse<OperationResult>(GlobalData.ServerRootUri + "MaterialOutStorageInfo/Update",
