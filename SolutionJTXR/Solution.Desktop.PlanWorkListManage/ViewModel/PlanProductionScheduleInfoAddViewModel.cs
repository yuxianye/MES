...
namespace Solution.Desktop.PlanWorkListManage.ViewModel
{
    ...
    /// 新增
    /// </summary>
    public class PlanProductionScheduleInfoAddViewModel : VmBase
    {
        /// <summary>
        /// 构造函数
        /// </summary>
        public PlanProductionScheduleInfoAddViewModel()
        {
        ...
        #region 生产计划模型
        private PlanProductionScheduleInfoModel planProductionScheduleInfo = new PlanProductionScheduleInfoModel();
        ...
        public PlanProductionScheduleInfoModel PlanProductionScheduleInfo
        {
            ...
            set
            {
                Set(ref planProductionScheduleInfo, value);
        ...
        {
            PlanProductionScheduleInfo.OrderItem_Id = this.PlanOrderItemInfo.Id;
            PlanProductionScheduleInfo.IsPublish = false;
            PlanProductionScheduleInfo.FinishQuantity = 0;
            PlanProductionScheduleInfo.ScheduleStatus = PlanEnumModel.ScheduleStatus.UnStart;

            var result = Utility.Http.HttpClientHelper.PostResponse<OperationResult>(GlobalData.ServerRootUri + "PlanProductionScheduleInfo/Add",
            ...
            {
                //操作失败，显示错误信息
                //EnterpriseInfoList = new ObservableCollection<PlanProductionScheduleInfoModel>();
        ...
        private void getPageData()
        {
            ...
            stopwatch.Start();
#endif
            productinfo.Id = this.PlanOrderItemInfo.Product_Id;
