...
namespace Solution.Desktop.EquipmentKnifeToolTypeMap.ViewModel
{
    ...
    /// 新增
    /// </summary>
    public class EquipmentKnifeToolTypeMapEditViewModel : VmBase
    {
        /// <summary>
        /// 构造函数
        /// </summary>
        public EquipmentKnifeToolTypeMapEditViewModel()
        {
        ...
        {
            this.EquipmentKnifeToolTypeMapModel = parameter as EquipmentKnifeToolTypeMapModel;
        }
        #region 装备模型
        ...
        private void OnExecuteConfirmCommand()
        {
            ...
            Utility.Http.HttpClientHelper.SetAccessTokenToHttpClient(GlobalData.AccessTocken);
            var result = Utility.Http.HttpClientHelper.PostResponse<OperationResult>(GlobalData.ServerRootUri + "EquipmentKnifeToolTypeMap/Update",
