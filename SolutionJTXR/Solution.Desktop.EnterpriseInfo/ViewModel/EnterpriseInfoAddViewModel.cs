...
namespace Solution.Desktop.EnterpriseInfo.ViewModel
{
    ...
    /// 新增VM
    /// </summary>
    public class EnterpriseInfoAddViewModel : VmBase//《注意：模块主VM与增加和编辑VM继承的基类不同》
    {
        /// <summary>
        /// 构造函数
        /// </summary>
        public EnterpriseInfoAddViewModel()
        {
        ...
        private void OnExecuteConfirmCommand()
        {
            ...
            var result = Utility.Http.HttpClientHelper.PostResponse<OperationResult>(GlobalData.ServerRootUri + "EnterpriseInfo/Add",
