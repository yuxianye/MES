...
{
    public class PlanOrderItemInfoAddViewModel : VmBase
    {
        /// <summary>
        /// 构造函数
        /// </summary>
        public PlanOrderItemInfoAddViewModel()
        {
        ...
        {
            this.PlanOrderItemInfo.Order_Id = new Guid(parameter.ToString());
        }
        /// <summary>
        /// 执行确认命令函数
        /// </summary>
        ...
        {
            PlanOrderItemInfo.OrderState = PlanEnumModel.OrderState.UnStart;
            PlanOrderItemInfo.RemainQuantity = PlanOrderItemInfo.OrderQuantity;

            var result = Utility.Http.HttpClientHelper.PostResponse<OperationResult>(GlobalData.ServerRootUri + "PlanOrderItemInfo/Add",
            ...
            {
                //操作失败，显示错误信息
                //EnterpriseInfoList = new ObservableCollection<PlanOrderItemInfoModel>();
