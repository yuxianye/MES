...
namespace Solution.Desktop.CommOpcUaBusiness.ViewModel
{
    ...
    /// 新增
    /// </summary>
    public class CommOpcUaBusinessEditViewModel : VmBase
    {
        /// <summary>
        /// 构造函数
        /// </summary>
        public CommOpcUaBusinessEditViewModel()
        {
        ...
        {
            this.CommOpcUaBusinessModel = parameter as CommOpcUaBusinessModel;
            //CommOpcUaNodeInfo = CommOpcUaNodeInfoList.Where(x=>x.NodeName.Equals(this.CommOpcUaBusinessModel.NodeName)).FirstOrDefault();
        }
        ...
        private void OnExecuteConfirmCommand()
        {
            ...
            var result = Utility.Http.HttpClientHelper.PostResponse<OperationResult>(GlobalData.ServerRootUri + "CommOpcUaBusiness/Update",
