...
{
  public  class ProManufacturingBOMBillItemInfoModel : ModelBase,  IAudited
    {
        #region Id
        private Guid id ;
        ...
        {
            get { return materiallName; }
            set { Set(ref materiallName, value); }
        }
        ...
        //{
        //    get { return materialUnitName; }
        //    set { Set(ref materialUnitName, value); }
        //}
