...
{
   public  class ProManufacturingBORBillItemInfoEditViewModel : VmBase
    {
        /// <summary>
        /// 构造函数
        /// </summary>
        public ProManufacturingBORBillItemInfoEditViewModel()
        {
        ...
        {
            this.ProManufacturingBORBillItemInfo = parameter as ProManufacturingBORBillItemInfoModel;
            InitProcessData();
        }

        #region 配方明细模型
        private ProManufacturingBORBillItemInfoModel BORBillItemModel = new ProManufacturingBORBillItemInfoModel();
        ...
        {
            get { return BORBillItemModel; }
            set
            {
                Set(ref BORBillItemModel, value);
        ...
        private void OnExecuteConfirmCommand()
        {
            ...
            var result = Utility.Http.HttpClientHelper.PostResponse<OperationResult>(GlobalData.ServerRootUri + "ProManufacturingBORBillItemInfo/Update",
        ...
        private void InitProcessData()
        {
            ...
            stopwatch.Start();
#endif
            ruleInfo.Id = ProManufacturingBORBillItemInfo.ProductionRule_Id;
