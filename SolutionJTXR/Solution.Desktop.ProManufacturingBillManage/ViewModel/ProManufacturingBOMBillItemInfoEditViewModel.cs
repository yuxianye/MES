...
{
   public  class ProManufacturingBOMBillItemInfoEditViewModel : VmBase
    {
        /// <summary>
        /// 构造函数
        /// </summary>
        public ProManufacturingBOMBillItemInfoEditViewModel()
        {
        ...
        {
            this.ProManufacturingBOMBillItemInfo = parameter as ProManufacturingBOMBillItemInfoModel;
            InitProcessData();
        }

        #region 配方明细模型
        private ProManufacturingBOMBillItemInfoModel bomBillItemModel = new ProManufacturingBOMBillItemInfoModel();
        ...
        {
            get { return bomBillItemModel; }
            set
            {
                Set(ref bomBillItemModel, value);
        ...
        {
            //ProductionRuleItemInfoModel.Id = CombHelper.NewComb();
            ProManufacturingBOMBillItemInfo.LastUpdatedTime = DateTime.Now;
            //ProductionRuleItemInfoModel.CreatedTime = DateTime.Now;
            //ProductionRuleItemInfoModel.IsDeleted = false;

            var result = Utility.Http.HttpClientHelper.PostResponse<OperationResult>(GlobalData.ServerRootUri + "ProManufacturingBOMBillItemInfo/Update",
        ...
        private void InitProcessData()
        {
            ...
            stopwatch.Start();
#endif
            ruleInfo.Id = ProManufacturingBOMBillItemInfo.ProductionRule_Id;
