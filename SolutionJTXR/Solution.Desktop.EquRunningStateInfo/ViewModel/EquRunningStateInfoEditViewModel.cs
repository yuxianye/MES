...
namespace Solution.Desktop.EquRunningStateInfo.ViewModel
{
    ...
    /// 新增
    /// </summary>
    public class EquRunningStateInfoEditViewModel : VmBase
    {
        /// <summary>
        /// 构造函数
        /// </summary>
        public EquRunningStateInfoEditViewModel()
        {
        ...
        {
            this.EquRunningStateInfoModel = parameter as EquRunningStateInfoModel;
        }
        #region 设备运行状态模型
        ...
        public System.Array EquRunningStateTypes//EquRunningStateTypes
        {
        ...
        private void getPageData(int pageIndex, int pageSize)
        {
            ...
            else
            {
                ...
                UiMessage = result?.Message ?? "查询地标信息失败，请联系管理员！";
            }
        }
        #endregion
        ...
        {
            var result = Utility.Http.HttpClientHelper.PostResponse<OperationResult>(GlobalData.ServerRootUri + "EquRunningStateInfo/Update",
