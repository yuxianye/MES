...
{
    public class DisStepActionInfoAddViewModel : VmBase
    {
        /// <summary>
        /// 构造函数
        /// </summary>
        ...
        {
            var result = Utility.Http.HttpClientHelper.PostResponse<OperationResult>(GlobalData.ServerRootUri + "DisStepActionInfo/Add",
