...
{
    public class MatInventoryItemInfoAddViewModel : VmBase
    {
        /// <summary>
        /// 构造函数
        /// </summary>
        ...
        {
            this.MatInventoryItemInfo.MatInventory_Id = new Guid(parameter.ToString());
        }
        ...
        {
            //MatInventoryItemInfo.OrderState = PlanEnumModel.OrderState.未开始;
            //MatInventoryItemInfo.RemainQuantity = MatInventoryItemInfo.OrderQuantity;
            //
            var result = Utility.Http.HttpClientHelper.PostResponse<OperationResult>(GlobalData.ServerRootUri + "MatInventoryInfo/AddItem",
            ...
            {
                //操作失败，显示错误信息
                //EnterpriseInfoList = new ObservableCollection<MatInventoryItemInfoModel>();
