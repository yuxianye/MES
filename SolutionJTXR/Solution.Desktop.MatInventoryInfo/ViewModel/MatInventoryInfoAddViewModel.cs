...
namespace Solution.Desktop.MatInventoryInfo.ViewModel
{
    ...
    /// </summary>
    public class MatInventoryInfoAddViewModel : VmBase
    {
        /// <summary>
        /// 构造函数
        /// </summary>
        ...
        {
            var result = Utility.Http.HttpClientHelper.PostResponse<OperationResult>(GlobalData.ServerRootUri + "MatInventoryInfo/Add",
