...
namespace Solution.Desktop.EntDepartmentInfo.ViewModel
{
    ...
    /// 新增VM
    /// </summary>
    public class EntDepartmentInfoAddViewModel : VmBase//《注意：模块主VM与增加和编辑VM继承的基类不同》
    {
        /// <summary>
        /// 构造函数
        /// </summary>
        public EntDepartmentInfoAddViewModel()
        {
        ...
        {
            //EnterpriseModel.Id = CombHelper.NewComb();

           
            var result = Utility.Http.HttpClientHelper.PostResponse<OperationResult>(GlobalData.ServerRootUri + "EntDepartmentInfo/Add",
