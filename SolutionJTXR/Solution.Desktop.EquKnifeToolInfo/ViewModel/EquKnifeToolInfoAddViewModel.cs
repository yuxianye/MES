...
namespace Solution.Desktop.EquKnifeToolInfo.ViewModel
{
    ...
    /// 新增
    /// </summary>
    public class EquKnifeToolInfoAddViewModel : VmBase
    {
        /// <summary>
        /// 构造函数
        /// </summary>
        public EquKnifeToolInfoAddViewModel()
        {
        ...
        {
            var result = Utility.Http.HttpClientHelper.PostResponse<OperationResult>(GlobalData.ServerRootUri + "EquKnifeToolInfo/Add",
