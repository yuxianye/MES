...
namespace Solution.Desktop.EntEmployeeInfo.ViewModel
{
    ...
    /// 新增
    /// </summary>
    public class EntEmployeeInfoEditViewModel : VmBase
    {
        /// <summary>
        /// 构造函数
        /// </summary>
        public EntEmployeeInfoEditViewModel()
        {
        ...
        {
            this.EntEmployeeInfoModel = parameter as EntEmployeeInfoModel;
            //getPageData1();
        }
        ...
        {
            var result = Utility.Http.HttpClientHelper.PostResponse<OperationResult>(GlobalData.ServerRootUri + "EntEmployeeInfo/Update",
        ...
        private void getPageData1()
        {
            ...
            entDepartmentInfoModel.Id = EntEmployeeInfoModel.DepartmentCode;


            
            var result = Utility.Http.HttpClientHelper.PostResponse<OperationResult<PageResult<EntSiteInfoModel>>>(GlobalData.ServerRootUri + "EntSiteInfo/GetEntSiteListByEnterpriseID", Utility.JsonHelper.ToJson(EntDepartmentInfoList));
