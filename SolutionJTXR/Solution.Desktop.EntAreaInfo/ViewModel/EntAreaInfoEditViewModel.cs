...
namespace Solution.Desktop.EntAreaInfo.ViewModel
{
    ...
    /// 新增
    /// </summary>
    public class EntAreaInfoEditViewModel : VmBase
    {
        /// <summary>
        /// 构造函数
        /// </summary>
        public EntAreaInfoEditViewModel()
        {
        ...
        {
            this.EntAreaInfoModel = parameter as EntAreaInfoModel;
            getPageData1();
        }

        #region 车间模型
        private EntAreaInfoModel areaModel = new EntAreaInfoModel();
        ...
        {
            var result = Utility.Http.HttpClientHelper.PostResponse<OperationResult>(GlobalData.ServerRootUri + "EntAreaInfo/Update",
