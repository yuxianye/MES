...
namespace Solution.Desktop.Agv.ViewModel
{
    ...
    /// 编辑
    /// </summary>
    public class TaskInfoEditViewModel : VmBase
    {
        /// <summary>
        /// 构造函数
        /// </summary>
        ...
        {
            this.TaskInfoModel = parameter as TaskInfoModel;
        ...
        private void OnExecuteConfirmCommand()
        {
            ...
            Utility.Http.HttpClientHelper.SetAccessTokenToHttpClient(GlobalData.AccessTocken);
            var result = Utility.Http.HttpClientHelper.PostResponse<OperationResult>(GlobalData.ServerRootUri + "TaskInfo/Update",
