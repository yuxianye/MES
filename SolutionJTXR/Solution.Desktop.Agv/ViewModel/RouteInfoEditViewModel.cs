...
namespace Solution.Desktop.Agv.ViewModel
{
    ...
    /// 编辑
    /// </summary>
    public class RouteInfoEditViewModel : VmBase
    {
        /// <summary>
        /// 构造函数
        /// </summary>
        public RouteInfoEditViewModel()
        {
        ...
        {
            this.RouteInfoModel = parameter as RouteInfoModel;
        ...
        private void OnExecuteConfirmCommand()
        {
            ...
            Utility.Http.HttpClientHelper.SetAccessTokenToHttpClient(GlobalData.AccessTocken);
            var result = Utility.Http.HttpClientHelper.PostResponse<OperationResult>(GlobalData.ServerRootUri + "RouteInfo/Update",
