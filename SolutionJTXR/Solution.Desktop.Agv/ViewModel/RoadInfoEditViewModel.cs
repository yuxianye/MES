...
namespace Solution.Desktop.Agv.ViewModel
{
    ...
    /// 编辑
    /// </summary>
    public class RoadInfoEditViewModel : VmBase
    {
        /// <summary>
        /// 构造函数
        /// </summary>
        public RoadInfoEditViewModel()
        {
        ...
        {
            this.RoadInfoModel = parameter as RoadInfoModel;
        ...
        private void OnExecuteConfirmCommand()
        {
            ...
            Utility.Http.HttpClientHelper.SetAccessTokenToHttpClient(GlobalData.AccessTocken);
            var result = Utility.Http.HttpClientHelper.PostResponse<OperationResult>(GlobalData.ServerRootUri + "RoadInfo/Update",
