...
namespace Solution.Desktop.MatStorageMoveInfo.ViewModel
{
    ...
    /// </summary>
    public class MatStorageMoveInfoAddViewModel : VmBase
    {
        /// <summary>
        /// 构造函数
        /// </summary>
        public MatStorageMoveInfoAddViewModel()
        {
            ...
            //未开始
            MatStorageMoveInfo.StorageMoveState = StorageMoveStateEnumModel.StorageMoveState.StorageMoveUnFinishState;
        ...
        {
            var result = Utility.Http.HttpClientHelper.PostResponse<OperationResult>(GlobalData.ServerRootUri + "MatStorageMoveInfo/Add",
        ...
        private void getPageDataWareHouseLocation(int pageIndex, int pageSize)
        {
            ...
            //增加校验(库位必须可用) by cxh 20181127
            FilterGroup filterGroup = new FilterGroup(FilterOperate.And);
            FilterRule filterRule1 = new FilterRule("IsUse", true, FilterOperate.Equal);
