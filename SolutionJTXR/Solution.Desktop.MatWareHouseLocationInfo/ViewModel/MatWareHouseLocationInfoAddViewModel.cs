...
namespace Solution.Desktop.MatWareHouseLocationInfo.ViewModel
{
    ...
    /// </summary>
    public class MatWareHouseLocationInfoAddViewModel : VmBase
    {
        /// <summary>
        /// 构造函数
        /// </summary>
        public MatWareHouseLocationInfoAddViewModel()
        {
        ...
        #region 仓库库位模型
        private MatWareHouseLocationInfoModel matWareHouseLocationModel = new MatWareHouseLocationInfoModel();
        /// <summary>
        /// 仓库库位模型
        /// </summary>
        public MatWareHouseLocationInfoModel MatWareHouseLocationInfo
        {
            get { return matWareHouseLocationModel; }
            set
            {
                Set(ref matWareHouseLocationModel, value);
        ...
        {
            var result = Utility.Http.HttpClientHelper.PostResponse<OperationResult>(GlobalData.ServerRootUri + "MatWareHouseLocationInfo/Add",
