...
namespace Solution.Desktop.Communication.Model
{
    ...
    /// Socket通信模型
    /// </summary>
    public class SocketServerModel : ModelBase, IAudited/*, IRecyclable, ILockable*/
    {
        #region Id
        ...
        [Required(ErrorMessage = "必填项，限50个字符"), MaxLength(20, ErrorMessage = "长度小于50个字符")]
        ...
        [Required(ErrorMessage = "必填项，限15个字符"), MaxLength(15, ErrorMessage = "长度小于15个字符")]
        ...
        [Required(ErrorMessage = "必填项，1-65535")]
        ...
        [Required(ErrorMessage = "必填项，非0正整数")]
