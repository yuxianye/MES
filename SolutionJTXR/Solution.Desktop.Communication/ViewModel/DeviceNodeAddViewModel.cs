...
namespace Solution.Desktop.Communication.ViewModel
{
    ...
    /// 新增
    /// </summary>
    public class DeviceNodeAddViewModel : VmBase
    {
        /// <summary>
        /// 构造函数
        /// </summary>
        ...
        /// 设备数据点数据模型
        /// </summary>
        private DeviceNodeModel deviceNodeModel = new DeviceNodeModel();
        /// <summary>
        /// O设备数据点数据模型
        /// </summary>
        ...
        private void OnExecuteConfirmCommand()
        {
            ...
            else if (DeviceServerInfo != null)
            {
                ...
                this.DeviceNodeModel.DeviceServerInfo_Id = this.DeviceServerInfo.Id;
                this.DeviceNodeModel.DeviceServerInfoName = this.DeviceServerInfo.DeviceServerName;
                var result = Utility.Http.HttpClientHelper.PostResponse<OperationResult>(GlobalData.ServerRootUri + "DeviceNode/Add",
