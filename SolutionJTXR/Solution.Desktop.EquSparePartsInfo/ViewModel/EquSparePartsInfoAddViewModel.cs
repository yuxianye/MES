...
namespace Solution.Desktop.EquSparePartsInfo.ViewModel
{
    ...
    /// 新增
    /// </summary>
    public class EquSparePartsInfoAddViewModel : VmBase
    {
        /// <summary>
        /// 构造函数
        /// </summary>
        public EquSparePartsInfoAddViewModel()
        {
        ...
        public System.Array SparePartUnit//EquRunningStateTypes
        {
        ...
        {
            var result = Utility.Http.HttpClientHelper.PostResponse<OperationResult>(GlobalData.ServerRootUri + "EquSparePartsInfo/Add",
