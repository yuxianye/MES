...
namespace Solution.Desktop.EquipmentInfo.ViewModel
{
    ...
    /// 新增
    /// </summary>
    public class EquipmentInfoAddViewModel : VmBase
    {
        /// <summary>
        /// 构造函数
        /// </summary>
        public EquipmentInfoAddViewModel()
        {
        ...
        System.Array equEquipmentState = Enum.GetValues(typeof(EquEquipmentState)).Cast<EquEquipmentState>().Select(value => new { Key = value, Value = value.ToDescription() }).ToArray();

        public System.Array EquEquipmentState
        {
            get { return equEquipmentState; }
            set
            {
                Set(ref equEquipmentState, value);
            }
        }
        ...
        private void OnExecuteConfirmCommand()
        {
            ...
            var result = Utility.Http.HttpClientHelper.PostResponse<OperationResult>(GlobalData.ServerRootUri + "EquipmentInfo/Add",
